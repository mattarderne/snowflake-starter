...
GRANT USAGE ON ALL SCHEMA in "RAW" to ROLE "LOADER";
GRANT USAGE ON DATABASE "RAW" TO ROLE "TRANSFORMER";
GRANT USAGE ON ALL SCHEMA in "RAW" to ROLE "TRANSFORMER";
...
GRANT USAGE ON ALL SCHEMA in "ANALYTICS" to ROLE "TRANSFORMER";
GRANT USAGE ON DATABASE "ANALYTICS" TO ROLE "REPORTER";
GRANT USAGE ON ALL SCHEMA in "ANALYTICS" to ROLE "REPORTER";

-- Not sure what dbt_dev database is for? 
...
GRANT USAGE ON ALL SCHEMA in "DBT_DEV" to ROLE "TRANSFORMER"

GRANT CREATE SCHEMA, MODIFY, MONITOR, USAGE ON DATABASE "DW_DEV" TO ROLE "REPORTER";
GRANT USAGE ON DATABASE "DW_DEV" TO ROLE "REPORTER";
GRANT USAGE ON ALL SCHEMA in "DW_DEV" to ROLE "TRANSFORMER";
--
