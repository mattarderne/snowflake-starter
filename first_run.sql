...
GRANT ALL PRIVILEGES ON WAREHOUSE "WAREHOUSE_INGEST" TO ROLE "ROLE_INGEST";
GRANT ALL PRIVILEGES ON WAREHOUSE "WAREHOUSE_TRANSFORM" TO ROLE "ROLE_TRANSFORM";
GRANT ALL PRIVILEGES ON WAREHOUSE "WAREHOUSE_REPORT" TO ROLE "ROLE_REPORT";
...
GRANT USAGE ON DATABASE "RAW" TO ROLE "ROLE_TRANSFORM";
GRANT USAGE ON FUTURE SCHEMAS IN DATABASE "RAW" TO "ROLE_TRANSFORM";
GRANT SELECT ON FUTURE TABLES IN DATABASE "RAW" TO ROLE "ROLE_TRANSFORM";
GRANT SELECT ON FUTURE VIEWS IN DATABASE "RAW" TO ROLE "ROLE_TRANSFORM";
-- assign RAW database privileges to ROLE_INGEST and ROLE_TRANSFORM

GRANT CREATE SCHEMA, MODIFY, MONITOR, USAGE ON DATABASE "ANALYTICS" TO ROLE "ROLE_TRANSFORM";
GRANT USAGE ON DATABASE "ANALYTICS" TO ROLE "ROLE_TRANSFORM";
GRANT USAGE ON ALL SCHEMAS in DATABASE "ANALYTICS" to ROLE "ROLE_TRANSFORM";
GRANT USAGE ON DATABASE "ANALYTICS" TO ROLE "ROLE_REPORT";
GRANT USAGE ON FUTURE SCHEMAS IN DATABASE "ANALYTICS" TO "ROLE_REPORT";
GRANT SELECT ON FUTURE TABLES IN DATABASE "ANALYTICS" TO ROLE "ROLE_REPORT";
GRANT SELECT ON FUTURE VIEWS IN DATABASE "ANALYTICS" TO ROLE "ROLE_REPORT";
